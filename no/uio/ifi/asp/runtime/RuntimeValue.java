...
public abstract class RuntimeValue {
    ...
    public RuntimeValue evalFuncCall(ArrayList<RuntimeValue> actualParams, AspSyntax where) {
		System.out.println("Naa kalles evalfunccall men den finner ikke noe:(");
	runtimeError("evalfunc'Function call (...)' undefined for "+typeName()+"!", where);
	return null;  // Required by the compiler!
    }
	...
	public ArrayList<RuntimeValue> getList(String what, AspSyntax where){
		runtimeError("getlist'Function call (...)' undefined for "+typeName()+"!", where);
		return null;
	}
